...
{
  /* <span
className="absolute left-1/2 m-4 mx-auto -translate-x-1/2 translate-y-full rounded-md bg-stone-300 px-1 
text-sm text-stone-800 opacity-0 transition-opacity group-hover:opacity-80"
> */
}
...
function ButtonPopup({ children, disabled, to, type, toolTip }) {
  ...
  const base =
    " group text-sm translate-colors inline-block rounded-full bg-yellow-400 font-semibold uppercase tracking-wide   text-stone-800 duration-300 hover:bg-yellow-300 focus:outline-none    focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed ";
  const styles = {
